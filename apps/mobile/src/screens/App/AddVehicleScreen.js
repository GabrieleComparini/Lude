  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (imageUri) {
        ...
        vehicleData.append('vehicleImage', {
          uri: imageUri,
          name: imageName,
          type: imageType
        });
        ...
        // Add other fields
        vehicleData.append('nickname', nickname.trim());
        vehicleData.append('make', make.trim());
        vehicleData.append('model', model.trim());
        if (year.trim()) vehicleData.append('year', year.trim());
        vehicleData.append('isDefault', isDefault.toString());
      ...
      await apiClient.post('/api/vehicles', vehicleData, requestConfig);
      ...
      if (err.response && err.response.data && err.response.data.message) {
        ...
        Alert.alert('Errore', 'Impossibile aggiungere il veicolo. Riprova più tardi.');
      }
    } finally {
      setLoading(false);
    }
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Inserisci i dettagli del tuo veicolo</Text>
        </View>
